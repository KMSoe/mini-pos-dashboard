    ...
    <div class="card mt-2 bg-white p-5">
        <form @submit.prevent="handleSubmit(!v$.$invalid)" class="fadeinout animation-duration-500">
            <div class="w-full mx-auto">
                ...
                <Button type="submit" label="Create Customer" class="w-full p-3 text-xl mt-5" />
            </div>
        </form>
...
import { useNewCustomer } from './useNew'
import Loading from '@/components/Loading.vue'

const { loading, villages, selectedVillage, v$, handleSubmit, submitted } = useNewCustomer()
</script>
